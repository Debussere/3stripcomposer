...
# all pools from text file, compositions.txt file generated by possible_combinations.py
...
def composition_creator(possiblecombinations):
    ...
    for combination in possiblecombinations:
        ...
        for i in range(0, NR_OF_GENERATED_COMPOSITIONS):
            ...
            nr_of_loops = 0
            # keep on shuffling until the composition is allowed
            while True:
                random.shuffle(lenght_pool)
                # reset container
                ...
                nr_of_loops +=1
                # check if composition is allowed
